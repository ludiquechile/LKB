...
void cameraSettings2d::closeEvent(QCloseEvent *event)
{
    cout << "1" << endl;
    timer->stop();
    cout << "2" << endl;
...
void cameraSettings2d::on_calBack_released()
{
    ...
    cConfig->BM->start(ui->back_num_frames->value());
...
void cameraSettings2d::on_should_process_chkbox_toggled(bool checked)
{
    should_process = checked;
}
